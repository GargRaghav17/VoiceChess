...
# BLACK_JOKER = pygame.image.load('imag/black_joker.png')u
...
# WHITE_JOKER = pygame.image.load('imag/white_joker.png')
ONE = pygame.image.load('img/one.png')
TWO = pygame.image.load('img/two.png')
THREE = pygame.image.load('img/three.png')
FOUR = pygame.image.load('img/four.jpg')
FIVE = pygame.image.load('img/five.jpg')
SIX = pygame.image.load('img/six.jpg')
SEVEN = pygame.image.load('img/seven.jpg')
EIGHT = pygame.image.load('img/eight.jpg')
a = pygame.image.load('img/a.jpg')
b = pygame.image.load('img/b.jpg')
c = pygame.image.load('img/c.jpg')
d = pygame.image.load('img/d.jpg')
e = pygame.image.load('img/e.jpg')
f = pygame.image.load('img/f.jpg')
g = pygame.image.load('img/g.jpg')
h = pygame.image.load('img/h.jpg')
...
fps = 60
SCREEN_TITLE = 'Two-Player Pygame Chess!'
...
def print_board(board, color=chess.WHITE):
    ...
    SCREEN.blit(pygame.transform.scale(ONE, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((8.5 * SQUARE_SIDE, int(0.25 * SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(TWO, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((8.5 * SQUARE_SIDE, int(1.25 * SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(THREE, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((8.5 * SQUARE_SIDE, int(2.25 * SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(FOUR, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((8.5 * SQUARE_SIDE, int(3.25 * SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(FIVE, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((8.5 * SQUARE_SIDE, int(4.25 * SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(SIX, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((8.5 * SQUARE_SIDE, int(5.25 * SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(SEVEN, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((8.5 * SQUARE_SIDE, int(6.25 * SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(EIGHT, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((8.5 * SQUARE_SIDE, int(7.25 * SQUARE_SIDE)), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(a, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((int(0.25 * SQUARE_SIDE), 8.5 * SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(b, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((int(1.25 * SQUARE_SIDE), 8.5 * SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(c, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((int(2.25 * SQUARE_SIDE), 8.5 * SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(d, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((int(3.25 * SQUARE_SIDE), 8.5 * SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(e, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((int(4.25 * SQUARE_SIDE), 8.5 * SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(f, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((int(5.25 * SQUARE_SIDE), 8.5 * SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(g, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((int(6.25 * SQUARE_SIDE), 8.5 * SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
    SCREEN.blit(pygame.transform.scale(h, (SQUARE_SIDE1, SQUARE_SIDE1)),
                pygame.Rect((int(7.25 * SQUARE_SIDE), 8.5 * SQUARE_SIDE), (SQUARE_SIDE1, SQUARE_SIDE1)))
